...
coeffTable()
{
    ...
    static const std::unordered_map<std::string, std::string> kTable =
    {
        ...
        { "0.0023", "\\frac{1}{432}"                 },
        { "0.0035", "\\frac{1}{288}"                 },
        { "0.0040", "\\frac{1}{144\\sqrt{3}}"        },
        { "0.0043", "\\frac{13}{300}"                },
        { "0.0046", "\\frac{1}{216}"                 },
        { "0.0056", "\\frac{1}{180}"                 },
        { "0.0069", "\\frac{1}{144}"                 },
        { "0.0080", "\\frac{1}{72\\sqrt{3}}"         },
        { "0.0085", "\\frac{1}{48\\sqrt{6}}"         },
        { "0.0093", "\\frac{5}{54}"                  },
        { "0.0104", "\\frac{1}{96}"                  },
        { "0.0120", "\\frac{\\sqrt{3}}{144}"         },
        { "0.0139", "\\frac{1}{72}"                  },
        { "0.0160", "\\frac{1}{36\\sqrt{3}}"         },
        { "0.0166", "\\frac{1}{60}"                  },
        { "0.0167", "\\frac{1}{60}"                  },
        { "0.0170", "\\frac{1}{24\\sqrt{6}}"         },
        { "0.0174", "\\frac{5}{288}"                 },
        { "0.0185", "\\frac{5}{27}"                  },
        { "0.0192", "\\frac{1}{30\\sqrt{3}}"         },
        { "0.0208", "\\frac{1}{48}"                  },
        { "0.0222", "\\frac{1}{45}"                  },
        ...
        { "0.0321", "\\frac{1}{18\\sqrt{3}}"         },
        { "0.0347", "\\frac{5}{144}"                 },
        { "0.0361", "\\frac{\\sqrt{3}}{48}"          },
        { "0.0370", "\\frac{1}{27}"                  },
        { "0.0375", "\\frac{3}{80}"                  },
        { "0.0400", "\\frac{1}{25}"                  },
        { "0.0417", "\\frac{1}{24}"                  },
        { "0.0433", "\\frac{\\sqrt{3}}{40}"          },
        { "0.0481", "\\frac{1}{12\\sqrt{3}}"         },
        { "0.0500", "\\frac{1}{20}"                  },
        { "0.0506", "\\frac{4}{25\\sqrt{10}}"        },
        { "0.0510", "\\frac{1}{8\\sqrt{6}}"          },
        { "0.0521", "\\frac{5}{96}"                  },
        { "0.0556", "\\frac{1}{18}"                  },
        { "0.0577", "\\frac{1}{10\\sqrt{3}}"         },
        { "0.0625", "\\frac{1}{16}"                  },
        { "0.0666", "\\frac{1}{15}"                  },
        { "0.0667", "\\frac{1}{15}"                  },
        ...
        { "0.1083", "\\frac{\\sqrt{3}}{16}"          },
        { "0.1111", "\\frac{1}{9}"                   },
        { "0.1250", "\\frac{1}{8}"                   },
        { "0.1299", "\\frac{3\\sqrt{3}}{40}"         },
        // ── Common fractions ──────────────────────────────────────────
        ...
        { "0.4444", "\\frac{4}{9}"                   },
        { "0.4472", "\\frac{1}{\\sqrt{5}}"           },
        { "0.4500", "\\frac{9}{20}"                  },
        { "0.4714", "\\frac{2}{3\\sqrt{2}}"          },
        { "0.5000", "\\frac{1}{2}"                   },
        { "0.5774", "\\frac{1}{\\sqrt{3}}"           },
        { "0.5926", "\\frac{16}{27}"                 },
        { "0.6250", "\\frac{5}{8}"                   },
        { "0.6667", "\\frac{2}{3}"                   },
        { "0.6708", "\\frac{3}{2\\sqrt{5}}"          },
        ...
        { "0.8889", "\\frac{8}{9}"                   },
        { "0.8944", "\\frac{2}{\\sqrt{5}}"           },
        // ── Unit and above ────────────────────────────────────────────
        { "1.0000", ""                               },  // unit: write nothing
        { "1.1180", "\\frac{\\sqrt{5}}{2}"           },
        { "1.1547", "\\frac{2}{\\sqrt{3}}"           },
        { "1.2000", "\\frac{6}{5}"                   },
        ...
        { "1.5000", "\\frac{3}{2}"                   },
        { "1.5811", "\\frac{5}{2}"                   },
        { "1.6330", "2\\sqrt{\\frac{2}{3}}"          },
        { "1.7321", "\\sqrt{3}"                      },
        { "1.7778", "\\frac{16}{9}"                  },
        { "2.0000", "2"                              },
        { "2.1213", "\\frac{3}{\\sqrt{2}}"           },
        { "2.2361", "\\sqrt{5}"                      },
        { "2.3094", "\\frac{4}{\\sqrt{3}}"           },
        { "2.4495", "2\\sqrt{\\frac{3}{2}}"          },
        { "2.5000", "\\frac{5}{2}"                   },
	{ "2.6666", "\\frac{8}{3}"                   },
	{ "2.6667", "\\frac{8}{3}"                   },
        { "2.8284", "2\\sqrt{2}"                     },
